<template>
  <div class="container ms-3 me-3">
      ...
      <div class="sidebar-header">
        <h2 class="sidebar-title">
          ...
          <button
            v-if="user.role"
            class="add-button"
            @click="openModalCreateImageTypeModalCompVue()"
          >
            + Novo
          </button>
        </h2>
        <div id="filter">
          <div class="filter-item-container">
            ...
            <InputComp
              ...
              name="pesquisa"
              type="pesquisar"
              placeHolder="Pesquisar tipo de imagem"
          ...
          <tbody>
            <tr v-for="imageType in paginatedTypes" :key="imageType.id">
              ...
              <td>
                ...
                <button
                  v-if="user.role"
                  @click="openDeleteModal(imageType)"
                  class="btn"
                >
      ...
      <nav class="pagination justify-content-center">
        <ul class="pagination">
          ...
          <li class="page-item">
            <button
              @click="proximaPagina"
              :disabled="!existemMaisPaginas"
              class="page-link btn-proximo"
            >
              Próxima
            </button>
          </li>
    ...
    <CreateImageTypeModalCompVue
      v-if="showCreateImageTypeModalCompVue"
      @close-modal="closeModal"
    />
    <EditImageTypeModalCompVue
      v-if="showEditImageTypeModalCompVue"
      @close-modal="closeModal"
    />
    <ShowImageTypeModalCompVue
      v-if="showViewImageTypeModalCompVue"
      :imageType="selectedImageType"
      @close-modal="closeModal"
    />
    <DeleteImageTypeModalCompVue
      v-if="showDeleteImageTypeModalCompVue"
      @close-modal="closeModal"
    />
  </div>
</template>
