		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h2 class="modal-title">Cadastro tipo de Imagem</h2>
				...
				<div class="modal-body">
					...
					<input class="form-control" type="text" v-model="inputValue" @keyup.enter="saveValue(0)"
					...
					<input class="form-control" type="text" v-model="inputValueOpcional" @keyup.enter="saveValue(1)"
