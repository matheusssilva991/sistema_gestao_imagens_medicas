		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h2 class="modal-title">Visualização de tipo de imagem</h2>
				...
				<div class="modal-body">
					...
					<input disabled class="form-control" type="text" v-model="this.name" aria-label="name"
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-success" @click="closeModal">Fechar</button>
				</div>
